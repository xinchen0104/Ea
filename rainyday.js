...
Drop.prototype.animate = function() {
	...
	var x = this.x;
	var y = this.y;
	this.rainyday.background.getContext("2d").drawImage(this.rainyday.orgimage,(x-10)/this.rainyday.xscale,(y-10)/this.rainyday.yscale,20/this.rainyday.xscale,20/this.rainyday.yscale,x-10,y-10,20,20);
